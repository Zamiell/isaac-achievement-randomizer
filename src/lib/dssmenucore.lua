function DSSInitializerFunction(DSSModName, DSSCoreVersion, MenuProvider)
...
-- Modified by Zamiel to return a standard Lua module.
return {
    DSSInitializerFunction = DSSInitializerFunction,
}
