...
/**
 * Multiplayer is illegal in the mod, so if multiplayer is detected, the run is forcefully ended.
 * (This is because it would allow people to play locked characters.)
 */
export class DisableMultiplayer extends RandomizerModFeature {
  /**
